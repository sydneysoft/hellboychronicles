  ...
  banner.innerHTML = `
    <div class="sl-cookie-inner">
      <div>
        ...
        <p>StoryLingo uses essential browser storage for language and reading preferences, privacy-friendly first-party analytics to measure aggregate usage, and Google reCAPTCHA for security and abuse prevention when enabled.</p>
      </div>
